...
Game::Game(unsigned int width, unsigned int height)
        : State(GAME_MENU), Keys(), KeysProcessed(), Width(width), Height(height), Level(0), Lives(4), Points()
{
}
...
void Game::Init()
{
    ...
    ResourceManager::LoadTexture("resources/textures/hearts4.png", true, "hearts4");
    ...
    glm::vec2 hearts4Pos = glm::vec2(0.0f, 0.0f);
    Hearts4 = new GameObject(hearts4Pos, glm::vec2(HEART4_SIZE), ResourceManager::GetTexture("hearts4"));
...
void Game::Render()
{
    if (this->State == GAME_ACTIVE || this->State == GAME_MENU || this->State == GAME_WIN || this->State == GAME_ATTACK || this->State == GAME_HURT || this->State == GAME_LOSE)
    {
        ...
        // render the hearts and the text to the screen
        if (Lives == 4)
        {
            Hearts4->Draw(*Renderer);
            Text->RenderText("4 / 4 = 1 = 100% life",
                             this->Width / 2.0f - 200.0f, 800.0f, // position
                             1.5f, // size
        ...
        if (Lives == 3)
        {
            ...
            Text->RenderText("3 / 4 = .75 = 75% life",
                             this->Width / 2.0f - 200.0f, 800.0f, // position
                             1.5f, // size
                             glm::vec3(0.0f, 1.0f, 0.0f)); // color
        }
        if (Lives == 2)
        {
            ...
            Text->RenderText("2 / 4 = 1/2 = .5 = 50% life",
                             this->Width / 2.0f - 200.0f, 800.0f, // position
                             1.5f,  // size
                             glm::vec3(0.0f, 1.0f, 0.0f)); //color
        }
        if (Lives == 1)
        {
            ...
            Text->RenderText("1 / 4 = .25 = 25% life",
                             this->Width / 2.0f - 200.0f, 800.0f, // position
                             1.5f,  // size
                             glm::vec3(0.0f, 1.0f, 0.0f)); // color
        }
